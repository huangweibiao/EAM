...
public interface AssetCategoryRepository extends JpaRepository<AssetCategory, Long>, JpaSpecificationExecutor<AssetCategory> {
     ...
     * 根据状态查询
     */
    List<AssetCategory> findByStatus(Integer status);

    /**
     * 模糊查询分类名称
     */
    List<AssetCategory> findByCategoryNameContaining(String keyword);
    ...
    Page<AssetCategory> search(@Param("categoryCode") String categoryCode,
